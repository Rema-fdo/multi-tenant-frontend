...
// Each role area keeps its own token so you can, for example, be logged in as
// an admin in one tab and an end user in another without them clobbering each
// other. The key is namespaced by role area.
